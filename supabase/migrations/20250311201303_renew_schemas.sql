...
alter table "public"."household_items" drop constraint if exists "household_items_pkey";

alter table "public"."household_items" drop column "id";
alter table "public"."household_items" add column "id" bigint generated by default as identity primary key;
