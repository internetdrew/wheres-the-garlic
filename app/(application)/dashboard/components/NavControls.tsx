...
const PendingMemberCard = ({
  ...
  return (
    <MenuItem>
      {({}) => (
        <li className='flex items-start gap-2 text-neutral-200 flex-1 w-52 py-4'>
          <Image
  ...
  return (
    <div className='flex items-center gap-2'>
      <div className='relative flex items-center'>
        <Menu>
          <MenuButton className='relative cursor-pointer'>
            <BellIcon className='size-5 lg:size-6' />
            {pendingMemberships && <PendingMembersPing />}
          </MenuButton>

          <MenuItems className='absolute flex flex-col bg-neutral-900 divide-y divide-neutral-700 px-4 rounded-lg top-full translate-y-2 left-1/2 -translate-x-1/2 text-sm lg:left-auto lg:right-0 lg:translate-x-0'>
